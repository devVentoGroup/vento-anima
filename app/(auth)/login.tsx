...
export default function LoginScreen() {
  ...
  const Container: any = isWeb ? View : KeyboardAvoidingView
          ...
          <View style={styles.cardInner}>
            ...
            <View style={styles.field}>
              ...
              <TextInput
                ...
                autoComplete={isWeb ? "username" : "email"}
                returnKeyType="next"
                ...
                style={[styles.input, isWeb && styles.inputWeb, emailFocused && styles.inputFocused]}
              />
            </View>
            ...
            <View style={styles.field}>
              ...
              <View style={styles.passwordRow}>
                <TextInput
                  ...
                  autoComplete={isWeb ? "current-password" : "password"}
                  returnKeyType="done"
                  onSubmitEditing={handleLogin}
                  placeholderTextColor={COLORS.neutral}
                  style={[styles.input, isWeb && styles.inputWeb, styles.passwordInput, passwordFocused && styles.inputFocused]}
                />
